...
<style lang="postcss" global>
	:local(select) {
		@apply rounded border-neutral-300 pt-0 pb-0 text-neutral-700 focus:border-primary-300 focus:ring-primary-700/70 dark:border-dark-400 dark:bg-dark-600 dark:text-neutral-200 dark:focus:border-primary-600;
