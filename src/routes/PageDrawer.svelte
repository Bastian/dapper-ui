...
>
	<Accordion class="d4r-my-2" expanded>
		<AccordionHeader slot="header">
			<div class="svg-container d4r-flex d4r-items-center d4r-gap-2">
				<Text contrast="lower"><Notebook /></Text>
				<Text weight="semibold" size="sm">Getting Started</Text>
			</div>
		</AccordionHeader>
		<div class="d4r-mt-2 d4r-flex d4r-w-full d4r-flex-col d4r-items-start d4r-gap-2 d4r-p-0.5">
			<DrawerLink
	...
	<Accordion class="d4r-my-2" expanded>
		...
		<div class="d4r-mt-2 d4r-flex d4r-w-full d4r-flex-col d4r-items-start d4r-gap-2 d4r-p-0.5">
			...
			<DrawerLink
				{...getDrawerLinkProps('/docs/accordion', $page.route.id)}
				on:click={handleDrawerLinkClick}
			>
				Accordion
			</DrawerLink>
